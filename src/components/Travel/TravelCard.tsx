      ...
      >
        ...
        <div className="flex flex-wrap justify-between gap-1">
          <div className="flex items-center">
            ...
            <div>
              ...
              {journey.location && (
                <span className="text-xs font-mono text-foreground/45 flex">
                  {journey.location}
                  <MountainSnow className="inline w-3.5 h-3.5 ml-4" />
                  {/* &bull; */}
                  {journey.altitude}
                </span>
              )}
          ...
          <span className="text-xs font-mono">{journey.season}</span>
          {/* </div> */}
        </div>

        {/* Type pill */}
        {/* <div className="text-xs font-mono text-foreground/60"> */}
        <p className="text-xs">&bull; Journey Type &ndash; {journey.type}</p>
        {/* </div> */}
        ...
        {journey.highlights.length > 0 && (
          <div className="flex flex-wrap gap-1.5">
            {journey.highlights.map((h, i) => (
              <span key={i} className="text-xs font-mono text-foreground/70">
                &bull; {h}
              </span>
            ))}
          </div>
        ...
        {photos.length > 0 ? (
          ...
          <div className="mt-2 pt-3 border-t border-black/[0.06] dark:border-white/[0.06] flex items-center gap-2 text-xs font-mono text-foreground/45">
            ...
            <span>
              Photos currently being curated &bull; Will populate automatically
              once moved to public/travel
            </span>
          </div>
        )}
      </Container>
