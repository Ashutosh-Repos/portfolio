...
export async function seedDatabase() {
  ...
  // 4a. GitHub Repo Snapshots (Directly reflecting Ashutosh's live GitHub profile)
  ...
  // FeaturedPriority 1-6 map EXCLUSIVELY to the 6 pinned repositories on GitHub
  const projectsData = [
    {
      id: 'proj-tessera',
      slug: 'tessera',
    ...
    // Remaining non-pinned authentic public repositories (featuredPriority: null)
    {
      id: 'proj-chatify',
      slug: 'chatify',
      title: 'Chatify',
    ...
    .values([
      {
        ...
        payloadJson: JSON.stringify({
          ...
          impact: { stars: 7, forks: 0, followers: 1 },
          activity: {
            totalCommits: 482,
            mergedPRs: 15,
            closedIssues: 7,
          ...
          streak: { currentStreak: 0, longestStreak: 7 },
          languages: [
      ...
      },
      {
        ...
        payloadJson: JSON.stringify({
          ...
          accuracy: {
            acceptanceRate: 81.2,
            totalSubmissions: 202,
            acceptedSubmissions: 164,
          },
