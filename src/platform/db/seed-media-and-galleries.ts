...
export async function seedMediaAndGalleries() {
  ...
  const insertMediaList = async (
    files: ReturnType<typeof scanFolder>,
    prefix: string,
  ) => {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      if (prefix === 'travel') {
        if (lowerName.includes('zoo'))
          caption = 'Shaheed Ashfaq Ullah Khan Zoological Park, Gorakhpur';
        else if (lowerName.includes('nauka'))
          caption = 'Nauka Vihar & Ramgarh Tal Lakefront, Gorakhpur';
        else if (lowerName.includes('taj'))
          caption = 'Taj Mahal & Yamuna Riverfront, Agra';
        else if (lowerName.includes('nepal') || lowerName.includes('lumbini'))
          caption = 'Lumbini Sacred Sanctuary, Nepal';
        else if (lowerName.includes('kushinagar'))
          caption = 'Mahaparinirvana Temple, Kushinagar';
      }
  ...
  const gkpTravelMediaIds = travelFiles
    ...
    .filter(
      ({ f }) =>
        f.filename.toLowerCase().includes('zoo') ||
        f.filename.toLowerCase().includes('nauka'),
    )
    .map(({ id }) => id);
  ...
  const nepalTravelMediaIds = travelFiles
    ...
    .filter(
      ({ f }) =>
        f.filename.toLowerCase().includes('nepal') ||
        f.filename.toLowerCase().includes('lumbini'),
    )
    .map(({ id }) => id);
  ...
  const galleries = [
    {
      ...
      description:
        'Foundational years completing Matriculation (Class X) in Science with 75.16%.',
    ...
    },
    {
      ...
      description:
        'Senior secondary education completing Class XII in Physics, Chemistry, and Mathematics (PCM) with 77.8%.',
    ...
    },
    {
      ...
      description:
        'Three-year technical diploma curriculum (2020-2023) covering engineering mechanics, thermodynamics, and design fundamentals.',
    ...
    },
    {
      ...
      description:
        'Undergraduate engineering journey at Madan Mohan Malaviya University of Technology (2023-2026), systems engineering, campus life, and deep work.',
    ...
    },
    {
      ...
      description:
        'Lakeside boating and sunsets at Nauka Vihar (Ramgarh Tal), and wild habitat trails at Shaheed Ashfaq Ullah Khan Zoological Park.',
    ...
    },
    {
      ...
      description:
        'Mughal architectural wonder, symmetrical ivory marble domes, and riverside reflections in Agra, Uttar Pradesh.',
    ...
    },
    {
      ...
      description:
        'Trans-Himalayan crossing into Nepal. Exploring the sacred birthplace of Gautama Buddha at Lumbini, Maya Devi Temple, and ancient monastic ruins.',
    ...
    },
    {
      ...
      description:
        'Historical and spiritual expedition to Kushinagar, the sacred site of Gautama Buddha’s Mahaparinirvana, ancient stupas, and peaceful terracotta grounds.',
  ...
  const educationEntries = [
    {
      ...
      isCurrent: true,
      description:
        'Undergraduate engineering studies in Computer Science. Core coursework in Operating Systems, Database Management Systems, Computer Networks, Compilers, and Distributed Computing.',
    ...
    },
    {
      ...
      isCurrent: false,
      description:
        'Completed 3-year technical diploma program in Mechanical Engineering. Built foundational strengths in applied mechanics, thermodynamics, engineering drawings, and industrial manufacturing.',
      highlightsJson: JSON.stringify([
    ...
    },
    {
      ...
      isCurrent: false,
      description:
        'Senior secondary certificate examination under Central Board of Secondary Education (CBSE) with rigorous specialization in Physics, Chemistry, and Advanced Mathematics.',
      highlightsJson: JSON.stringify([
    ...
    },
    {
      ...
      isCurrent: false,
      description:
        'Secondary school certificate examination under Central Board of Secondary Education (CBSE) with core focus on General Science, Mathematics, and Computer Applications.',
      highlightsJson: JSON.stringify([
  ...
  await db
    ...
    .where(sql`${schema.education.id} = 'edu-btech'`);
  ...
  const experiences = [
    {
      ...
      isCurrent: false,
      description:
        'Web development internship delivering user-facing volunteer portals and scalable backend service routes.',
      responsibilitiesJson: JSON.stringify([
        'Completed 4-month Web Development Internship (1st Feb 2026 to 30th May 2026) under Regd no. U85300CT2020NPL010641.',
      ...
      achievementsJson: JSON.stringify([
        'Successfully completed internship with certificate issued on 05/06/2026 by Sr. HR Manager Vignesh N.',
      ...
      storyMarkdown:
        'Working with InAmigos gave me hands-on experience building accessible, high-performance web products that serve real human needs under diverse network conditions.',
      companyUrl:
        'https://drive.google.com/file/d/1SQrXxg3viKmNpgP_BHYK1gy1h07X_2Y6/view?usp=sharing',
    ...
    },
    {
      ...
      isCurrent: false,
      description:
        'Open-source developer utility suite — Authored Pull Request #370 resolving model migrations and storage keys.',
      responsibilitiesJson: JSON.stringify([
        'Authored and submitted Pull Request #370 (sohzm/cheating-daddy#370): updated outdated Gemini/Gemma models and migrated limits storage keys.',
        'Migrated realtime Live connection in gemini.js from deprecated gemini-2.5-flash-native-audio-preview-09-2025 to gemini-3.1-flash-live-preview.',
        'Migrated text fallback model from defunct gemma-3-27b-it to gemini-2.5-flash-lite, resolving 404/500 errors across 7 linked community issues (#358, #352, #339, #318, #324, #365, #368).',
        'Refactored character usage tracking in storage.js to dynamically initialize and migrate limits keys in limits.json, cleaning up deprecated keys on startup.',
      ]),
      achievementsJson: JSON.stringify([
        'Authored core PR #370 resolving 7 high-priority community-reported issues.',
        'Integrated automated CodeRabbit review validation and multi-model configuration.',
      ]),
      technologiesJson: JSON.stringify([
        'JavaScript',
        'Node.js',
      ...
      storyMarkdown:
        'Contributing to Cheating Daddy gave me direct experience with high-scale open source repositories, real-time audio/multimodal streaming APIs, and model lifecycle deprecation handling.',
      companyUrl: 'https://github.com/sohzm/cheating-daddy/pull/370',
  ...
  await db
    ...
    .values({
      ...
      currentFocus:
        'Distributed systems, Go microservices, database storage internals, and AI agents.',
      location: 'India',
      ...
      socialLinksJson: JSON.stringify([
        ...
        {
          platform: 'LeetCode',
          url: 'https://leetcode.com/u/ashutosh0406',
        ...
        {
          platform: 'Email',
          url: 'mailto:clashutosh04@gmail.com',
          username: 'clashutosh04@gmail.com',
          icon: 'mail',
        },
      ]),
      updatedAt: now,
  ...
  console.log(
    '✨ Completed seeding media, galleries, education, experience, and profile!',
  );
}
